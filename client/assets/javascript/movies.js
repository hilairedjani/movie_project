const movies = [
  ...
  },
  {
    ...
    Writer:
      "Terry McMillan (novel), Terry McMillan (screenplay), Ronald Bass (screenplay)",
    ...
    Poster:
      "https://m.media-amazon.com/images/M/MV5BYzcyMDY2YWQtYWJhYy00OGQ2LTk4NzktYWJkNDYwZWJmY2RjXkEyXkFqcGdeQXVyMTA0MjU0Ng@@._V1_SX300.jpg",
    Ratings: [
  ...
  },
  {
    ...
    Writer:
      'Albert Hackett (screenplay "Father\'s Little Dividend"), Frances Goodrich (screenplay "Father\'s Little Dividend"), Nancy Meyers (screenplay), Charles Shyer (screenplay)',
    Actors:
  ...
  },
  {
    ...
    Poster:
      "https://m.media-amazon.com/images/M/MV5BMDJjNWE5MTEtMDk2Mi00ZjczLWIwYjAtNzM2ZTdhNzcwOGZjXkEyXkFqcGdeQXVyNDIzMzcwNjc@._V1_SX300.jpg",
    Ratings: [
  ...
  },
  {
    ...
    Writer:
      "Samuel A. Taylor (play), Billy Wilder (earlier screenplay), Samuel A. Taylor (earlier screenplay), Ernest Lehman (earlier screenplay), Barbara Benedek (screenplay), David Rayfiel (screenplay)",
    ...
    Poster:
      "https://m.media-amazon.com/images/M/MV5BYjQ5ZjQ0YzQtOGY3My00MWVhLTgzNWItOTYwMTE5N2ZiMDUyXkEyXkFqcGdeQXVyNjUwMzI2NzU@._V1_SX300.jpg",
    Ratings: [
  ...
  },
  {
    ...
    Writer:
      "Mark Twain (novel), Stephen Sommers (screenplay), David Loughery (screenplay)",
    ...
    Poster:
      "https://m.media-amazon.com/images/M/MV5BN2ZkZTMxOTAtMzg1Mi00M2U0LWE2NWItZDg4YmQyZjVkMDdhXkEyXkFqcGdeQXVyNTM5NzI0NDY@._V1_SX300.jpg",
    Ratings: [
  ...
  },
  {
    ...
    Actors:
      "Jean-Claude Van Damme, Powers Boothe, Raymond J. Barry, Whittni Wright",
    Plot:
    ...
    Awards: "N/A",
    Poster:
      "https://m.media-amazon.com/images/M/MV5BN2NjYWE5NjMtODlmZC00MjJhLWFkZTktYTJlZTI4YjVkMGNmXkEyXkFqcGdeQXVyNDc2NjEyMw@@._V1_SX300.jpg",
    Ratings: [
  ...
  },
  {
    ...
    Writer:
      "Ian Fleming (characters), Michael France (story), Jeffrey Caine (screenplay), Bruce Feirstein (screenplay)",
